...
| **M10** JS / C# | ~~QuickJS +~~ Node from Termux, de-risked by spike R13; **mono** rather than the .NET SDK, which Termux does not publish | Node project runs; C# console app compiles |
